...
<table>
    ...
    <tr>
        <th>역할</th>
        <th>관리자 부분 개발, <br>버그수정, <br>문서작업, <br>발표보조</th>
        <th>관리자 부분 개발, <br>소스취합, <br>문서작업, <br>버그수정</th>
        <th>교육생 부분 개발, <br>문서작업, <br>의견제안</th>
        <th>교사 부분 개발, <br>소스취합, <br>발표</th>
        <th>교사 부분 개발, <br>의견제안</th>
        <th>관리자 부분 개발, <br>데이터수정, <br>문서작성</th>
    </tr>
</table>
